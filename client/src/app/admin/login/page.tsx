    ...
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden bg-[#0B0E14]">
      ...
      <div className="w-full max-w-[420px] relative z-10">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
            ...
            <div>
              ...
              <div className="flex justify-end mt-2">
                <Link href="/forgot-password" className="text-[0.75rem] text-accent hover:underline">
                  Forgot Password?
                </Link>
              </div>
            </div>
        ...
        <div className="text-center mt-6">
          <Link href="/" className="text-gray-600 text-[0.82rem] hover:text-gray-400 transition-colors">
