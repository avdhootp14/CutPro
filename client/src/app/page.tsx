      ...
      <nav className="fixed top-0 w-full z-50 bg-bgPrimary/80 backdrop-blur-lg border-b border-white/5">
        <div className="container mx-auto px-4 sm:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link href="/partner-signup" className="text-[0.9rem] text-gray-300 hover:text-white font-medium transition-colors hidden md:block">
              For Businesses
            </Link>
            <Link href="/admin/login" className="btn btn-outline text-[0.85rem] px-5 py-2">
              Salon Login
            </Link>
          </div>
        </div>
